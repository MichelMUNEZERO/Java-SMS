...
/**
 * Servlet to handle nurse dashboard
 */
...
public class DashboardServlet extends HttpServlet {
    ...
    /**
     * Handle GET requests - show nurse dashboard
     */
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Get today's appointment count (instead of specific nurse appointments)
            int todayAppointments = appointmentDAO.countTodayAppointments();
            request.setAttribute("todayAppointments", todayAppointments);
            
            // Forward to nurse dashboard page
            request.getRequestDispatcher("/nurse_dashboard.jsp").forward(request, response);
        } catch (Exception e) {
            e.printStackTrace();
            request.setAttribute("errorMessage", "Error loading nurse dashboard: " + e.getMessage());
