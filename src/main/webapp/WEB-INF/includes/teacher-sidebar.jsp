  ...
  <div class="position-sticky pt-4">
    ...
    <div class="px-3">
      <ul class="nav flex-column gap-1">
        <li class="nav-item">
          <a
            class="nav-link ${pageContext.request.requestURI.contains('/teacher/dashboard') || pageContext.request.requestURI.contains('teacher_dashboard.jsp') ? 'active-nav-link' : ''}"
        ...
        <li class="nav-item">
          <a
            class="nav-link ${pageContext.request.requestURI.contains('/teacher/course') ? 'active-nav-link' : ''}"
        ...
        <li class="nav-item">
          <a
            class="nav-link ${pageContext.request.requestURI.contains('/teacher/student') ? 'active-nav-link' : ''}"
            href="${pageContext.request.contextPath}/teacher/students"
          >
            <i class="bi bi-people me-3"></i> My Students
          </a>
        </li>
        <li class="nav-item">
          <a
            class="nav-link ${pageContext.request.requestURI.contains('/teacher/marks') ? 'active-nav-link' : ''}"
            href="${pageContext.request.contextPath}/teacher/marks"
          >
            <i class="bi bi-card-checklist me-3"></i> Marks & Grades
          </a>
        </li>
        <li class="nav-item">
          <a
            class="nav-link ${pageContext.request.requestURI.contains('/teacher/behavior') ? 'active-nav-link' : ''}"
            href="${pageContext.request.contextPath}/teacher/behavior"
          >
            <i class="bi bi-clipboard-check me-3"></i> Student Behavior
          </a>
        </li>
        <li class="nav-item">
          <a
            class="nav-link ${pageContext.request.requestURI.contains('/teacher/reports') ? 'active-nav-link' : ''}"
        ...
        <li class="nav-item">
          <a
            class="nav-link ${pageContext.request.requestURI.contains('/teacher/appointments') ? 'active-nav-link' : ''}"
            href="${pageContext.request.contextPath}/teacher/appointments"
          >
