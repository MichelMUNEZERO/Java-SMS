      ...
      <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
              ...
              <li class="nav-item">
                <div class="dropdown">
                  ...
                  >
                    ...
                    <span>Nurse ${sessionScope.user.username}</span>
                  </a>
          ...
          <div class="container-fluid mt-4 mb-5">
            <h2 class="h3 mb-4">Nurse Dashboard</h2>
            ...
            <div class="row mb-4">
                ...
                <div class="card bg-success text-white shadow-sm stats-card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      ...
                      <div>
                        <h6 class="card-title mb-0">Students In Care</h6>
                        <h2 class="mb-0">12</h2>
                      </div>
                    </div>
                  </div>
              ...
              <div class="col-md-4 mb-3">
                <div class="card bg-info text-white shadow-sm stats-card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <i class="bi bi-capsule fs-1 me-3"></i>
                      <div>
                        <h6 class="card-title mb-0">Medication Schedules</h6>
                        <h2 class="mb-0">23</h2>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card border-0 shadow-sm h-100">
                  ...
                  <div class="card-body">
                    <div class="row g-3">
                      <div class="col-md-6">
                        <a
                          href="${pageContext.request.contextPath}/nurse/visit/new"
                      ...
                      <div class="col-md-6">
                        <a
                          href="${pageContext.request.contextPath}/nurse/medication/new"
                          class="btn btn-outline-info w-100 py-3 quick-action"
                        >
                          <i class="bi bi-capsule mb-2 d-block fs-4"></i>
                          Add Medication
                        </a>
                      </div>
                      <div class="col-md-6">
                        <a
                          href="${pageContext.request.contextPath}/nurse/search-student"
                      ...
                      <div class="col-md-6">
                        <a
                          href="${pageContext.request.contextPath}/nurse/health-alert"
