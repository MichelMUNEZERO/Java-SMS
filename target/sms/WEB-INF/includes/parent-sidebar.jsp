  ...
  <div class="position-sticky pt-4">
    ...
    <div class="px-3">
      <ul class="nav flex-column gap-1">
        <li class="nav-item">
          <a
            class="nav-link ${pageContext.request.requestURI.contains('/parent/dashboard') || pageContext.request.requestURI.contains('parent_dashboard.jsp') ? 'active-nav-link' : ''}"
        ...
        <li class="nav-item">
          <a
            class="nav-link ${pageContext.request.requestURI.contains('/parent/student-progress') ? 'active-nav-link' : ''}"
            href="${pageContext.request.contextPath}/parent/student-progress"
          >
            <i class="bi bi-people me-3"></i> My Children
          </a>
        </li>
        <li class="nav-item">
          <a
            class="nav-link ${pageContext.request.requestURI.contains('/parent/academic-progress') ? 'active-nav-link' : ''}"
            href="${pageContext.request.contextPath}/parent/student-progress"
          >
            <i class="bi bi-card-checklist me-3"></i> Academic Progress
          </a>
        </li>
        <li class="nav-item">
          <a
            class="nav-link ${pageContext.request.requestURI.contains('/parent/announcements') ? 'active-nav-link' : ''}"
        ...
        <li class="nav-item">
          <a
            class="nav-link ${pageContext.request.requestURI.contains('/parent/appointments') ? 'active-nav-link' : ''}"
            href="${pageContext.request.contextPath}/parent/appointments"
          >
            <i class="bi bi-calendar-check me-3"></i> Book Appointments
          </a>
        </li>
        <li class="nav-item">
          <a
            class="nav-link ${pageContext.request.requestURI.contains('/parent/profile') ? 'active-nav-link' : ''}"
            href="${pageContext.request.contextPath}/parent/profile"
          >
